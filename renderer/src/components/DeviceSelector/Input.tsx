...
const Input: React.FunctionComponent<InputPropType> = ({
  ...
  return (
    <div className="w-full col-span-2 center cursor-text">
      <fieldset className="min-h-[115%] w-[80%] flex justify-evenly items-center border-2 border-gray-200 rounded-md focus-within:border-gray-500">
        ...
        <div className="center">
          <input
            ...
            className="w-full h-[2rem] cursor-text text-sm text-center bg-transparent focus:outline-white"
