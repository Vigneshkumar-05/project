      ...
      <div className="p-1">
        <div className="border px-2 py-2 rounded-md border-gray-200 mt-1">
            ...
            <div className="flex items-center justify-between mb-2">
                ...
                <button className="px-3 py-1 text-xs text-gray-800  rounded-full">Disabled</button>
            </div>
            <div className="mb-2">
                <label className="text-xs text-gray-400">I2C Target Address (GUI side)</label>
                <div className="flex items-center mt-1 justify-between">
                    <input 
                        ...
                        readOnly 
                    />
                    <button className="px-3 py-1 text-xs font-medium rounded-md border border-blue-800 text-blue-800">Find Address</button>
                </div>
            </div>
            <div>
        ...
        <div className="border px-2 py-2 rounded-md mt-2">
            <div className="flex items-center justify-between mb-2">
                ...
                <button className="px-3 py-1 text-xs font-small text-gray-400 rounded-full">Disable</button>
            </div>
        ...
        <div className="mt-2 border border-gray-200 px-2 py-2 rounded-md flex justify-between items-center">
            ...
            <button className="border text-sm font-normal px-4 py-0.5 text-red-700 border-red-700 hover:bg-red-700 hover:text-white rounded-md">EEPROM ⯆</button>
        </div>
      </div>  
    );
};
