  ...
  return (
    <div className="border p-4 rounded-lg shadow-md bg-white">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <button className="px-3 py-1 text-xs font-medium text-gray-600  rounded-full">
          Disabled
        </button>
      </div>
      <div className="mb-2">
        ...
        <div className="flex items-center space-x-2 mt-1">
          <input
            ...
            readOnly
          />
          <button className="px-3 py-1 text-xs font-medium rounded-md border border-blue-500 text-blue-500">
            Find Address
          </button>
        </div>
      </div>
      ...
      <div className="border p-4 rounded-lg shadow-md bg-white">
        <div className="flex items-center justify-between mb-2">
          ...
          <button className="px-3 py-1 text-xs font-medium text-white bg-gray-500 rounded-full">
            Disable
          </button>
        </div>
      ...
      <div className="border p-4 rounded-lg shadow-md bg-white flex justify-between items-center">
        ...
        <button className="px-4 py-2 text-black border-red-600 rounded-md">
          EEPROM ▼
        </button>
      </div>
    </div>
